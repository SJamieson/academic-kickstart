...
<PipelineReliability caption="Making components uncertainty-aware and letting the system <em>act</em> on low confidence lifts end-to-end reliability more than buying accuracy on any single component. (Toggle a stage, then turn on “act”. Synthetic 3-stage pipeline with correlated errors.)" />
