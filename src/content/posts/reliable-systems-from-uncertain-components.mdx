...
<PipelineReliability caption="Hover to set how much of the workload you hand to human review. Escalating the least-confident inputs first (teal) recovers far more reliability than escalating at random (grey) — and only the components’ uncertainty tells you which is which. (Synthetic 3-stage pipeline with correlated errors.)" />
